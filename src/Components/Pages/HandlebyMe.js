         ...
         <Link to="/HandleByMeFilter"><Button variant='danger' className='mx-3' size='sm'><i className="fas fa-filter me-2"style={{color:'#fff'}} ></i>Filter</Button></Link>
            ...
            <Container  className='table-data' fluid>
                <Table responsive className='data-table' hover >
                    <thead>
                        <tr>
                            <th>The assured delivery date </th>
                            <th>The minimum number of cvs submission required </th>
                            <th>Client coordinationwill be done by </th>
                            <th> Cvs quqlity by admin is required / not required for this JD?</th>
                            <th>I have chosen to use own databse/our database</th>
                            <th>JD location</th>
                            <th>Sign up rate</th>
                            <th>Payment terms</th>
