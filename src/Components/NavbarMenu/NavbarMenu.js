...
const NavbarMenu = () => {
  ...
  return (
    ...
    <Container fluid>
    <Navbar.Brand as={Link} to="/"><img src="/images/logo.jpeg" alt="logo" /><span className='text-white fw-bold mx-3 ' >Talent Trackers </span></Navbar.Brand>
  ...
  <Dropdown.Menu>
  <NavDropdown.Item href="#action/3.1"><i class="far fa-comment-dots me-2"></i>Start live chat </NavDropdown.Item>
          <NavDropdown.Item href="#action/3.2"><i class="fas fa-sms me-2"></i>SMS</NavDropdown.Item>
          <NavDropdown.Item href="#action/3.3"><i class="fab fa-whatsapp me-2"></i>Whatsapp</NavDropdown.Item>
